package by.traning.task10.dragon.view;
    ...
    public boolean processingOperation(int choice) {
        ...
        switch (choice){
            case 1:
                ...
                serviceTreasure.showAllTreasure();
                break;
            case 2:
                System.out.println("The most expensive treasure:");
                serviceTreasure.chooseMostExpensive();
                break;
            case 3:
                ...
                serviceTreasure.selectForGivenAmount(valueRange);
                break;
            case 4:
